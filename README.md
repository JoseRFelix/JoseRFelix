...
I write about React, animations, CSS, and web development at **[josefelix.dev](https://josefelix.dev/blog)**.

- [6 Tips for Tailwind CSS Development (with resources!)](https://josefelix.dev/blog/6-tips-for-tailwind-css-development-with-resources)
- [Why Use Tailwind CSS for Your Next Project](https://josefelix.dev/blog/why-use-tailwind-css-for-your-next-project)
- [Page Transitions In React](https://josefelix.dev/blog/page-transitions-in-react)
- [Getting Started with React Animations](https://josefelix.dev/blog/getting-started-with-react-animations)
- [Using React Spring to Animate SVG Icons: Dark Mode Toggle](https://josefelix.dev/blog/using-react-spring-to-animate-svg-icons-dark-mode-toggle)
